...
var Calendar = (function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function render() {
      ...
      var MoreControl = _props7.MoreControl;
      ...
      return _react2['default'].createElement(
        ...
        MoreControl && _react2['default'].createElement(MoreControl, null),
        _react2['default'].createElement(
          'div',
...
Calendar.propTypes = {
  MoreControl: _propTypes2['default'].oneOfType([_propTypes2['default'].object, _propTypes2['default'].func, _propTypes2['default'].string]),
